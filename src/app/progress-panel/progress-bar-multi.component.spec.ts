...
import { DepartmentService, RequirementService, FacultyService } from '../services';
...
describe('ProgressBarMulti component', () => {
   let departmentServiceMock = jasmine.createSpyObj('DepartmentService', ['getDepartments()'])
   let facultyServiceMock = jasmine.createSpyObj('FacultyService', ['getFaculties()'])
    ...
    beforeEach( waitForAsync(() => {
        ...
        providers: [RequirementService, { provide: DepartmentService, useValue: departmentServiceMock }, { provide: FacultyService, useValue: facultyServiceMock }, ProgressPanelService, ProgressBarMultiContainer, Store,  ],
        })
 ...
 it('should NOT set the hoverText if inactive', () => {
    ...
    expect(hoverText).toBe(null as any);
